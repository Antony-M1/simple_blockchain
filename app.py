...
class Blockchain:
    ...
    def __init__(self) -> None: # this function is called constructor
        self.chain = []
...
# Creating the Web app using the flask
app = Flask(__name__)
...
# Display blockchain in json fromat
...
def valid():
    ...
    if valid:
        ...
        response = {
            "messgae": "the Blockchain is not valid"
        }
    return jsonify(response), 200
